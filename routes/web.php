...
Route::get('/get-models','App\Http\Controllers\ModelsController@getModels')
    ->name('models.get');

Route::get('/advanced-search','App\Http\Controllers\VehiclesController@advancedSearch')
    ->name('models.get');

Route::get('/vehicle-details/{id}', 'App\Http\Controllers\VehiclesController@vehicleDetails')
  ->name('vehicles.vehicle-details');